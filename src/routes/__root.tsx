...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Núpublico: cria posts publicitários profissionais com IA em PT-AO." },
      { name: "author", content: "Núpublico" },
      { property: "og:title", content: "Núpublico — Cria conteúdo publicitário com IA" },
      { property: "og:description", content: "Núpublico: cria posts publicitários profissionais com IA em PT-AO." },
